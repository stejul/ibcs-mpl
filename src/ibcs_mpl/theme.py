...
def scenario_style(theme: IBCSTheme, scenario: ScenarioCode) -> FillStyle:
    mapping: dict[ScenarioCode, FillStyle] = {
        ScenarioCode.AC: FillStyle(facecolor=theme.actual_dark, edgecolor=theme.actual_dark, linewidth=0.8),
        ScenarioCode.PY: FillStyle(facecolor=theme.measured_light, edgecolor=theme.measured_light, linewidth=0.8),
        ...
        ScenarioCode.FC: FillStyle(facecolor=None, edgecolor=theme.actual_dark, hatch="///", linewidth=1.4),
    }
